        ...
        <div className="watch-video">
          ...
          <div className="watch-container">
            <p className="watch-title">
              Highlights | Pak vs Eng A beautiful match played between pakistan
              and England
            </p>
          ...
          <div className="comment-container">
            <div className="com-list">
              ...
              <div className="middle-box">
                ...
                <p className="comment-v">
                  Thank you for this video. I followed all the steps, now I have
                  a video player like YouTube in my website. I modify the code,
                  now I have a Responsive navig ation bar in smartphone, a
                  little code for backend , a simple dynamic video player will
                  born.
                </p>
            ...
            <div className="com-list">
              ...
              <div className="middle-box">
                ...
                <p className="comment-v">
                  This is the content we stay subscribed for! Thank you avinash,
                  you're single handedly teaching millions of us how to do front
                  end
                </p>
                <div className="com-react-box">
                  <BiLike className=" com-reaction" />
            ...
            <div className="com-list">
              ...
              <div className="middle-box">
                ...
                <p className="comment-v">
                  I can't find words to describe how grateful I am for this man.
                  Putting in time and efforts to create such videos like that
                  just for free so that our skills be improved. Thank Thank you!
                  May God bless you.
                </p>
                <div className="com-react-box">
                  <BiLike className=" com-reaction" />
